...
export const GET: APIRoute = async () => {
	...
	const sections: string[] = [
		...
		`> ${POSITIONING}`,
		"",
		`The public site for ${SITE_NAME}. The product is in active development — this surface is the overview and waitlist; full product documentation lives on the docs site.`,
		"",
		"## Pages",
		"",
